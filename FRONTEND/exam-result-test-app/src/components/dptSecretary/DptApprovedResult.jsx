...
function DptApprovedResult() {
    ...
    const pendingSheetId = useSelector((store) => store.dptSecretaryNavigationSlice?.pendingSecSheetId);
    const resultsSheets = useSelector((store) => store.dptSecretaryNavigationSlice?.studentHistoryResultsSheets || []);
