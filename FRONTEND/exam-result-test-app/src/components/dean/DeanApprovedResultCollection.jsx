...
function DeanApprovedResultCollection() {
    ...
    useEffect(() => {
        const fetchResultSheets = async () => {
            try {
                const response = await axios.get(`${host}/api/results/dean/approve/collection/${userId}`); 
    ...
    return (
        <div>
            <div className='flex flex-col items-center'>
                ...
                <ResultCollection userType="dean" resultSheets={resultSheets}/>
            </div>
        </div>
    )
}
export default DeanApprovedResultCollection
